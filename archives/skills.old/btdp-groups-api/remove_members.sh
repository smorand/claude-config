#!/bin/bash
# Remove members from a Google Cloud Identity group
# Usage: ./remove_members.sh <group_email> <member1> [member2] [member3] ...
# Example: ./remove_members.sh data-gcp-team@loreal.com user1@loreal.com user2@loreal.com
...
case "$HTTP_CODE" in
    200)
        echo "SUCCESS: All ${#MEMBERS[@]} member(s) removed from $GROUP_EMAIL"
        ;;
    206)
        echo "PARTIAL SUCCESS: Some members removed, some failed"
